            ...
            <div class="card-body">
                <form>
                    <div class="form-group">
                        ...
                        <select class="form-control" id="marksList" name="city"></select>

                        <label>Модель автомобиля</label>
                        <select class="form-control" id="modelsList" name="city"></select>

                        <label>Тип кузова</label>
                        <select class="form-control" id="bodiesList" name="city"></select>
